...
export class GerenciaTesoreria extends Component {
  setup(){
        this.state = useState({
            quotations: {
                value:10,
...
GerenciaTesoreria.template = "TobaccoMetricsPro.GerenciaTesoreria";
GerenciaTesoreria.components = { MetricCard, ChartRenderer};


// Log to console when adding to the registry to confirm it's being executed  ... 
console.log("Adding Dashboard to the registry");

registry.category("actions").add("TobaccoMetricsPro.GerenciaTesoreria", GerenciaTesoreria);