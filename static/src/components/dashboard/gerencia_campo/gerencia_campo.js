...
export class GerenciaCampo extends Component {
  setup(){
        this.state = useState({
            quotations: {
                value:10,
...
GerenciaCampo.template = "TobaccoMetricsPro.GerenciaCampo";
GerenciaCampo.components = { MetricCard, ChartRenderer};


// Log to console when adding to the registry to confirm it's being executed  ... 
console.log("Adding Dashboard to the registry");

registry.category("actions").add("TobaccoMetricsPro.GerenciaCampo", GerenciaCampo);