...
Gerencia_auditoria.template = "TobaccoMetricsPro.Gerencia_auditoria_";
...
registry.category("actions").add("TobaccoMetricsPro.Gerencia_auditoria_", Gerencia_auditoria);