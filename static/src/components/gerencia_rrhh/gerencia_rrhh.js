...
export class Gerencia_rrhh extends Component {
  setup(){
        this.state = useState({
            quotations: {
                value:10,
...
Gerencia_rrhh.template = "TobaccoMetricsPro.Gerencia_rrhh";
Gerencia_rrhh.components = { MetricCard, ChartRenderer};


// Log to console when adding to the registry to confirm it's being executed  ... 
console.log("Adding Dashboard to the registry");

registry.category("actions").add("TobaccoMetricsPro.Gerencia_rrhh", Gerencia_rrhh);